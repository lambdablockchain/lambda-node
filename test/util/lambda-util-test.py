...
# Copyright 2016-2017 The Lambda Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for lambda utils.
...
def main():
    ...
    bctester(os.path.join(config["environment"]["SRCDIR"], "test",
                          "util", "data"), "lambda-util-test.json", config["environment"])
...
def bctest(testDir, testObj, buildenv):
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, lambda-tx
