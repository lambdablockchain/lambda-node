...
import RPC call and node 0 sends LMA to it. Then other nodes import the
...
In the second part of the test, node 0 sends more LMA to each address, and the
...
class ImportRescanTest(LambdaTestFramework):
