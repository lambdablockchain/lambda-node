...
By default, lambdad will dump mempool on shutdown and
...
class MempoolPersistTest(LambdaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug(
            "Prevent lambdad from writing mempool.dat to disk. Verify that `savemempool` fails")
