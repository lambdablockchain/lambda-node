...
class WalletTest(LambdaTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 LMA from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 LMA with subtract fee from amount
        ...
        # Sendmany 10 LMA with subtract fee from amount
        ...
        blkHash = self.generatetoaddress(self.nodes[0], 1, cbAddr)[0]
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/lambda/lambda/issues/7463
            # '-salvagewallet',
        ]
