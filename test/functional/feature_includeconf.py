...
class IncludeConfTest(LambdaTestFramework):
    ...
    def setup_chain(self):
        ...
        with open(os.path.join(self.options.tmpdir, "node0", "lambda.conf"), "a", encoding='utf8') as f:
    ...
    def run_test(self):
        ...
        assert subversion.endswith("main; relative)/")
        self.stop_node(
            0, expected_stderr="warning: -includeconf cannot be used from included files; ignoring -includeconf=relative2.conf")
