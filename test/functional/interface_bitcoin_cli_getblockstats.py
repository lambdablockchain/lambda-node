...
class TestLambdaCliGetBlockStats(LambdaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Testing `lambda-cli getblockstats 0`")
        ...
        self.log.info("Testing `lambda-cli getblockstats '\"{}\"'`".format(block_0_hash))
...
if __name__ == '__main__':
    TestLambdaCliGetBlockStats().main()
