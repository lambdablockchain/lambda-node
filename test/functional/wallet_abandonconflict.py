...
class AbandonConflictTest(LambdaTestFramework):
    ...
    def run_test(self):
        ...
        # Verify that B and C's 10 LMA outputs are available for spending again
        ...
        # Invalidate the block with the double spend and B's 10 LMA output should no longer be available
