...
class ToolWalletTest(LambdaTestFramework):
    ...
    def lambda_wallet_process(self, *args):
        binary = self.config["environment"]["BUILDDIR"] + \
            '/src/lambda-wallet' + self.config["environment"]["EXEEXT"]
    ...
    def assert_raises_tool_error(self, error, *args):
        p = self.lambda_wallet_process(*args)
    ...
    def run_test(self):
        ...
        # `lambda-wallet help` is an error. Use `lambda-wallet -help`
