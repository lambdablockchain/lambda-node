...
echo "export URL=https://github.com/lambdablockchain/lambda-node.git"
echo "cd gitian-builder"
echo "./bin/make-base-vm --lxc --distro debian --suite stretch --arch amd64"
echo "./bin/gbuild --commit lambda=\${COMMIT} --url lambda=\${URL} /vagrant/contrib/gitian-descriptors/gitian-linux.yml"
