...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle,
        ...
        : QAbstractItemDelegate(parent), unit(LambdaUnits::BCH),
    ...
    inline void paint(QPainter *painter, const QStyleOptionViewItem &option,
        ...
        painter->setPen(foreground);
        QString amountText = LambdaUnits::formatWithUnit(
            unit, amount, true, LambdaUnits::separatorAlways);
        if (!confirmed) {
...
void OverviewPage::setBalance(const interfaces::WalletBalances &balances) {
    ...
    ui->labelBalance->setText(LambdaUnits::formatWithUnit(
        unit, balances.balance, false, LambdaUnits::separatorAlways));
    ui->labelUnconfirmed->setText(
        LambdaUnits::formatWithUnit(unit, balances.unconfirmed_balance, false,
                                     LambdaUnits::separatorAlways));
    ui->labelImmature->setText(LambdaUnits::formatWithUnit(
        unit, balances.immature_balance, false, LambdaUnits::separatorAlways));
    ui->labelTotal->setText(LambdaUnits::formatWithUnit(
        unit,
        balances.balance + balances.unconfirmed_balance +
            balances.immature_balance,
        false, LambdaUnits::separatorAlways));
    ui->labelWatchAvailable->setText(
        LambdaUnits::formatWithUnit(unit, balances.watch_only_balance, false,
                                     LambdaUnits::separatorAlways));
    ui->labelWatchPending->setText(LambdaUnits::formatWithUnit(
        unit, balances.unconfirmed_watch_only_balance, false,
        LambdaUnits::separatorAlways));
    ui->labelWatchImmature->setText(
        LambdaUnits::formatWithUnit(unit, balances.immature_watch_only_balance,
                                     false, LambdaUnits::separatorAlways));
    ui->labelWatchTotal->setText(LambdaUnits::formatWithUnit(
        unit,
