...
set(CPACK_PACKAGE_DESCRIPTION "Lambda Node is a Lambda full node implementation.")
set(CPACK_PACKAGE_HOMEPAGE_URL "${PROJECT_HOMEPAGE_URL}")
set(CPACK_PACKAGE_CONTACT "info@lambdanode.org")

set(CPACK_PACKAGE_INSTALL_DIRECTORY "Lambda-Node")
...
if(${CMAKE_SYSTEM_NAME} MATCHES "Windows")
	...
	set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}/share/pixmaps/lambda128.png")
...
set(_nsis_lambda_qt "lambda-qt.exe")

set(CPACK_NSIS_URL_INFO_ABOUT "${CPACK_PACKAGE_HOMEPAGE_URL}")
set(CPACK_NSIS_CONTACT "${CPACK_PACKAGE_CONTACT}")

set(CPACK_NSIS_MUI_ICON "${CMAKE_SOURCE_DIR}/share/pixmaps/lambda.ico")
...
set(CPACK_NSIS_MUI_FINISHPAGE_RUN "${_nsis_lambda_qt}")
set(CPACK_NSIS_INSTALLED_ICON_NAME "${CMAKE_INSTALL_BINDIR}/${_nsis_lambda_qt}")
...
set(CPACK_NSIS_MENU_LINKS "${CMAKE_INSTALL_BINDIR}/${_nsis_lambda_qt}" "Lambda Node")
