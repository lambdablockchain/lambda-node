...
The Bitcoin Cash Node daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Bitcoin Cash Node requires the ZeroMQ API >= 4.1.5
...
For instance:
    ...
    bitcoind -zmqpubhashtx=tcp://127.0.0.1:29332 \
