...
- port 9332 for mainnet,
- port 19332 for testnet,
- port 29332 for testnet4,
- port 39332 for scalenet,
...
<https://github.com/lambda/bips/blob/master/bip-0064.mediawiki>
...
Running a web browser on the same node with a REST enabled lambdad can be a risk.
Accessing prepared XSS websites could read out tx/block data of your node by placing
links like `<script src="http://127.0.0.1:9332/rest/tx/1234567890.json">` which
