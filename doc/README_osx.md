...
extracted using `contrib/macdeploy/extract-osx-sdk.sh` (since removed).
The method to extract the data on Linux from the `.dmg` file was elaborate
and has also been removed from this description for brevity - consult an
older version if you need to see those instructions / scripts.
